...
public class HttpConnector
{
    ...
    private HttpClient getHttpClient (int reintentosConexion, int timeoutConexion)
    {
        if (this.httpClient == null) {
            ...
            //Se configura el número de reintentos
            client.getParams().setParameter(HttpMethodParams.RETRY_HANDLER, 
                    new DefaultHttpMethodRetryHandler(reintentosConexion, false));
            
            //Se comprueban las propiedades proxy del sistema. Si están rellenas, se rellena
            ...
            //Se configura el timeout de la conexion. Primero se intenta asignar los parámetros
            //pasados. Si están vacíos, se pone el parámetro por defecto
